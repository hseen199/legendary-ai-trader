...
export default function WalletNew() {
  ...
  const canWithdraw = balance && balance.balance_usd >= MIN_WITHDRAWAL;
  const currentNAV = navData?.nav_value || 1.0;
                  ...
                  <form onSubmit={handleWithdraw} className="space-y-4">
                    <div>
                      ...
                      {canWithdraw && (
                        <button
                          type="button"
                          onClick={() => setWithdrawAmount(String(balance?.balance_usd || 0))}
